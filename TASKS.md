...
- [ ] ZCode 发布新版本时复验核心链路：插件加载、`/ultracode` 挂载、agent 注册、Explore/worker 实际派发，并追加 `docs/08` 记录。——实例记录：3.9.2 已复验（2026-08-27，`docs/08` §21）；3.10.1 已复验（2026-08-29，`docs/08` §22）；3.10.2 已复验（2026-08-31，`docs/08` §23）。
