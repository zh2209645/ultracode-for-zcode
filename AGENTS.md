...
- 平台核心复验（加载、挂载、注册、实际派发）已有 Windows（3.7.7 / 3.8.1 / 3.9.1 / 3.9.2 / 3.10.1 / 3.10.2）与 WSL2 记录（`docs/08` §11、§15、§16、§17、§21、§22、§23），新平台首次使用时照此格式补充。
